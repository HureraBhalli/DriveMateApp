      ...
      body: Column(
        ...
        children: [
                                 ...
                                 Column(
                                   crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      ...
                                      Text('*** ***** *** 2341', style: TextStyle(fontFamily: 'Poppins Medium', fontSize: 16, color: Color(0xff000000))),
                                    ]
                                 )
                               ]
                             ),
          ...
          const Padding(
            ...
            child: Align(
                alignment: Alignment.centerLeft,
                child: Text('Friends', style: TextStyle(fontFamily: 'Poppins Semibold', fontSize: 18, color: Color(0xff6763EE)),
                )),
          ),
